...
from src.extract_data_image import ExtractDataFromImageDETR
from src.extract_data_file import ExtractDataFromFile


class ProcessFiles:
    def __init__(self):
        self.extractor_image = ExtractDataFromImageDETR()
...
with gr.Blocks(title="Dosya İşleme Uygulaması") as app:
